    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: "#F9E8E4" }}>
          ...
          {themes.length === 0 ? (
            ...
            themes.map((theme) => (
              <div key={theme.id}
                ...
                <button
                  onClick={() => router.push(`/lecons?theme_id=${theme.id}`)}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t px-6 py-3"
        ...
        <div className="flex justify-around items-center">
          {[
            { label: "Accueil", active: true, path: "/dashboard", icon: <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>, icon2: <polyline points="9 22 9 12 15 12 15 22"/> },
            { label: "Lecons", active: false, path: "/lecons", icon: <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/>, icon2: <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/> },
            { label: "Quiz", active: false, path: "/quiz", icon: <circle cx="12" cy="12" r="10"/>, icon2: <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/> },
            { label: "Profil", active: false, path: "/profil", icon: <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>, icon2: <circle cx="12" cy="7" r="4"/> },
          ].map((item) => (
